...
class Video {
      AssetImage thumbnail= AssetImage('');
      int viewCount = 10;
      DateTime uploadDate=  DateTime(1);
      String videoTitle = 'Title';
      Channel channel = new Channel('channelName', AssetImage(''));

    Video({required AssetImage thumbnail,required int viewCount,required DateTime uploadDate,required String videoTitle,required Channel channel}) {
